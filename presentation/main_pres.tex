...
\begin{frame}{Theoretical Model}
    \framesubtitle{Example of $R_{0.7, 0.1}$}
...
\begin{frame}{Theoretical Model}
    ...
    \begin{figure}[!h]
        \begin{tikzpicture}
            ...
            \node at (3, 1) {$\$ 0.7$ +};
            \node at (3, 0.5) {\textcolor{blue}{$0.4$ RN}};
            \node at (5,-0.3) {$T$};
...
\begin{frame}{Theoretical Model}
    ...
    \begin{figure}[!h]
        \begin{tikzpicture}
            ...
            \node at (5,-0.3) {$T$};
            \node at (6, 0.5) {\textcolor{blue}{$\$ 0.4$}};
...
\begin{frame}{Simulation Results}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|c|cc|cccc|cccc|c|c|}
            ...
            \hline &&&&&&&&&&&& \\
            1 & A & $\Gamma$ & RN & 1 & 0/0.01 & 222.42 & RN & 1 & 0/0.01 & 24.73 & 222 & 209.39 \\ &&&&&&&&&&&& \\
            \hline &&&&&&&&&&&& \\
