...
\vspace{1em}
 ...
 %this for 1\% increase in the stock price - BUT we do it for dollar increase or 0.01 for volatility
...
\end{figure}
\vspace*{15pt}
%%INSERT GRAPH OF DEADWEIGHT COST WITH RN OPTION (?) - NOT SURE